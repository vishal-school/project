...
<html lang="en">
  ...
  <body>
    <div class="container mt-5">
        <form action="<?php echo e(url('/aboutcreate')); ?>" method="get">
            <?php echo csrf_field(); ?>
            <div class="row">
          ...
          <div class="form-group">
    <label for="name"> About school<span class="text-danger"> * </span> </label>
      <input type="text" name="about_message" class="form-control" value="<?php echo e(old('about_message')); ?>" />
      <?php echo $errors->first("about_message", "<span class='text-danger'>:message</span>"); ?>
...
<?php /**PATH E:\om\htdocs\omkaar\resources\views/school-about.blade.php ENDPATH**/ ?>