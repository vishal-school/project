...
<html lang="en">
  ...
  <body>
    <div class="container mt-5">
        <form action="<?php echo e(url('/principal_msg')); ?>" method="get">
            <?php echo csrf_field(); ?>
            <div class="row">
                <div class="col-xl-6 m-auto">
                    <div class="card shadow">
                        ...
                        <div class="card-header">
                            <h4 class="card-title font-weight-bold">About School</h4>
                        </div>
          ...
          <div class="form-group">
    <label for="name"> princi_message<span class="text-danger"> * </span> </label>
      <input type="text" name="princi_message" class="form-control" value="<?php echo e(old('princi_message')); ?>" />
      <?php echo $errors->first("princi_message", "<span class='text-danger'>:message</span>"); ?>
...
<?php /**PATH E:\om\htdocs\omkaar\resources\views/principal_message.blade.php ENDPATH**/ ?>